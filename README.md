...
این ماژول پشتیبانی کامل از تقویم جلالی (شمسی) را برای آکانتینگ نسخه ۳.۱.x فراهم می‌کند. این ماژول به طور یکپارچه با هسته آکانتینگ ادغام شده و تمام تاریخ‌ها را سمت کاربر (کلاینت) تبدیل می‌کند.
...
- **سازگاری کامل:** بدون تغییر در فایل‌های هسته آکانتینگ کار می‌کند.
...
```bash
# از پنل مدیریت آکانتینگ ماژول را غیرفعال و حذف کنید
# سپس فایل‌های ماژول را از دایرکتوری modules حذف کنید
...
- ماژول را از پنل مدیریت آکانتینگ فعال کنید.
